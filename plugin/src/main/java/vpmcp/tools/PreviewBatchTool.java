...
public final class PreviewBatchTool implements McpTool {
    ...
    private static final String DESCRIPTION =
            ...
            + "(points are absolute diagram coordinates and must span the full path "
            + "including the endpoints; intermediate-only points are straightened), "
            ...
            + "delete_diagram {id, diagram} (views go, models stay as orphans — "
            + "follow with delete_model), delete_element {id, element} "
            + "(removes the view and deletes its model). "
